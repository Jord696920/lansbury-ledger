...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Navigation */}
      <nav
        className="flex-1 overflow-y-auto px-2 py-3 scrollbar-none"
        aria-label="Primary"
      >
                ...
                const content = (
                  <>
                    ...
                    {!collapsed && item.comingSoon && (
                      <span className="ml-2 rounded-full bg-bg-elevated px-1.5 py-0.5 text-[9px] font-medium uppercase tracking-wide text-text-tertiary">
                        Soon
                      </span>
                    )}
                    {collapsed && (
